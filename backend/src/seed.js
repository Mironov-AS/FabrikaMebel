...
db.transaction(() => {
  insertOrderItem.run(1, 1, 'Кресло офисное «Комфорт-М»', 'KO-001', 50, 8500, 'Офисные кресла', 'produced', 20);
  insertOrderItem.run(2, 1, 'Стол рабочий 160×80', 'ST-160', 30, 12000, 'Столы', 'in_production', 0);
  insertOrderItem.run(3, 1, 'Тумба 3-ящичная', 'TU-003', 30, 5500, 'Тумбы', 'planned', 0);
